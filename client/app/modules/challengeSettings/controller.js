angular.module('cri.challengeSettings',[])
    .controller('ChallengeSettingsCtrl',['$scope','challenge','users','Challenge','Notification','$materialDialog','Project','$materialSidenav',function($scope,challenge,users,Challenge,Notification,$materialDialog,Project,$materialSidenav){
        ...
        $scope.popUpTemplate = function($event){
            $materialDialog({
                templateUrl : 'modules/challengeSettings/templates/modal/challenge-template-modal.tpl.html',
                escapeToClose : false,
