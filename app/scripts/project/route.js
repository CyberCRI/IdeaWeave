    ...
    .config(['$stateProvider',function ($stateProvider) {
        $stateProvider
            .state('projects',{
                ...
                views : {
                    mainView: {
                        templateUrl:'/scripts/project/templates/projects.tpl.html',
            ...
            .state('project',{
                ...
                views : {
                    mainView : {
                        templateUrl:'/scripts/project/templates/project.tpl.html',
            ...
            .state('project.join',{
                ...
                views :{
                    projectView : {
                        templateUrl:'/scripts/project/templates/join-project.tpl.html',
