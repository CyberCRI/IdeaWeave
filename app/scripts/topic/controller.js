angular.module('cri.topic',[])
    .controller('ProjectTopicDetailsCtrl',function($scope,$stateParams,Topic,toaster,Files,loggedUser){
    ...
    .controller('ProjectTopicCtrl',function($scope,Project,Topic,toaster,project,$stateParams){
